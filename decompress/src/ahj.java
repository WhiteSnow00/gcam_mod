...
public final class ahj extends Drawable
{
    ...
    static {
        b = new ahi(Integer.class);
        c = (TimeInterpolator)ahe.a;
    }
    ...
    public ahj() {
        ...
        final ObjectAnimator ofInt = ObjectAnimator.ofInt((Object)this, ahj.b, new int[] { 0, 10000 });
    ...
    public final void draw(final Canvas canvas) {
        ...
        float n2;
        if (n < 0.5f) {
            n2 = ahj.c.getInterpolation(a(0.0f, 0.5f, n)) * 306.0f;
        }
        else {
            n2 = (1.0f - ahj.c.getInterpolation(a(0.5f, 1.0f, n))) * 306.0f;
        }
