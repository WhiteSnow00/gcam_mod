...
public class ScriptIntrinsicConvolve3x3 extends ScriptIntrinsic
{
    ...
    public ScriptIntrinsicConvolve3x3(final long n, final RenderScript renderScript) {
        super(n, renderScript);
        this.mValues = new float[9];
    }
    
    public static ScriptIntrinsicConvolve3x3 create(final RenderScript renderScript, final Element element) {
        ...
        final ScriptIntrinsicConvolve3x3 scriptIntrinsicConvolve3x3 = new ScriptIntrinsicConvolve3x3(renderScript.nScriptIntrinsicCreate(1, element.getID(renderScript), false), renderScript);
    ...
    public void setCoefficients(final float[] array) {
        final FieldPacker fieldPacker = new FieldPacker(36);
        int n = 0;
        while (true) {
