...
public final class ox extends MultiAutoCompleteTextView
{
    ...
    public ox(final Context context, final AttributeSet set) {
        tl.a(context);
        super(context, set, 2130968644);
        tj.d((View)this, this.getContext());
        final to q = to.q(this.getContext(), set, ox.a, 2130968644);
        if (q.p(0)) {
            this.setDropDownBackgroundDrawable(q.h(0));
        }
        q.n();
        (this.b = new oo((View)this)).d(set, 2130968644);
        final ps c = new ps((TextView)this);
        (this.c = c).b(set, 2130968644);
        c.a();
    }
