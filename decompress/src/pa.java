...
public class pa extends RadioButton
{
    ...
    public pa(final Context context, final AttributeSet set) {
        tl.a(context);
        super(context, set, 2130969581);
        tj.d((View)this, this.getContext());
        (this.a = new or((CompoundButton)this)).a(set, 2130969581);
        (this.b = new oo((View)this)).d(set, 2130969581);
        (this.c = new ps((TextView)this)).b(set, 2130969581);
    }
